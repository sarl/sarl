 ...
 */
@DisplayName("serialization: def")
@Tag("core")
@Tag("serialization")
@SuppressWarnings("all")
public class ActionSerializerTest extends AbstractSerializerTest {
	...
	public void paramsDef_noReturn_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int = 6, b : float) { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void param_return_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int) : float { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void paramDef_return_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int = 5) : float { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void paramsDef_return_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int = 6, b : float) : float { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
