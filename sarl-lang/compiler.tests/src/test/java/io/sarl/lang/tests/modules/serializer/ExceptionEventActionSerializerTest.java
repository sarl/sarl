...
public class ExceptionEventActionSerializerTest extends AbstractSerializerTest {
	...
	public void noPar_noReturn_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct throws Exception fires foo.Event1, foo.Event2 { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
	...
	public void param_noReturn_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int) throws Exception fires foo.Event1, foo.Event2 { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void paramDef_noReturn_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int = 5) throws Exception fires foo.Event1, foo.Event2 { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void paramsDef_noReturn_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int = 6, b : float) throws Exception fires foo.Event1, foo.Event2 { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void noPar_return_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct : float throws Exception fires foo.Event1, foo.Event2 { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void param_return_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int) : float throws Exception fires foo.Event1, foo.Event2 { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void paramDef_return_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int = 5) : float throws Exception fires foo.Event1, foo.Event2 { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
	...
	public void paramsDef_return_noSuper() throws Exception {
		String s = multilineString(
				"agent Foo {", //$NON-NLS-1$
				"def fct(a : int = 6, b : float) : float throws Exception fires foo.Event1, foo.Event2 { 1 }", //$NON-NLS-1$
				"}"); //$NON-NLS-1$
		this.object = agent(getParseHelper(), getValidationHelper(), s);
		assertSerialize(s);
	}
