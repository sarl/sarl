...
public class MavenHelper {
	...
	public MavenHelper(MavenSession session, BuildPluginManager buildPluginManager, RepositorySystem repositorySystem,
			ResolutionErrorHandler resolutionErrorHandler, Logger log) throws MojoExecutionException {
	...
	/** Replies the group identifier of the SARL maven plugin.
	 *
	...
	public static String getSarlMavenPluginGroupId(Logger logger) {
		try {
			return getConfig("plugin.groupId", logger); //$NON-NLS-1$
		} catch (MojoExecutionException e) {
			throw new RuntimeException(e);
		}
	}

	/** Replies the artefact identifier of the SARL maven plugin.
	 *
	 * @return the artefact id, never {@code null}.
	 * @since 0.13
	 */
	...
	public static String getSarlMavenPluginArtifactId(Logger logger) {
		try {
			return getConfig("plugin.artifactId", logger); //$NON-NLS-1$
		} catch (MojoExecutionException e) {
			throw new RuntimeException(e);
		}
	}

	/** Replies the version of the SARL maven plugin.
	 *
	...
	public static String getSarlMavenPluginVersion(Logger logger) {
		try {
			return getConfig("plugin.version", logger); //$NON-NLS-1$
		} catch (MojoExecutionException e) {
			throw new RuntimeException(e);
		}
	}

	/** Replies the group identifier of the SARL SDK used by this plugin.
	 *
	 * @return the group id, never {@code null}.
	 * @since 0.13
	 */
	...
	public static String getSarlSdkGroupId(Logger logger) {
		try {
			return getConfig("sarl-sdk.groupId", logger); //$NON-NLS-1$
		} catch (MojoExecutionException e) {
			throw new RuntimeException(e);
		}
	}

	/** Replies the artifact identifier of the SARL SDK used by this plugin.
	 *
	...
	public static String getSarlSdkArtifactId(Logger logger) {
		try {
			return getConfig("sarl-sdk.artifactId", logger); //$NON-NLS-1$
		} catch (MojoExecutionException e) {
			throw new RuntimeException(e);
		}
	}

	/** Replies the version of the SARL SDK used by this plugin.
	 *
	 * @return the version, never {@code null}.
	 * @since 0.13
	 */
