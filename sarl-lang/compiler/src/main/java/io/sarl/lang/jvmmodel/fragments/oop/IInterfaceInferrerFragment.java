...
public interface IInterfaceInferrerFragment extends IInheritedStageInferrerFragment<XtendInterface, JvmGenericType> {

	@Override
	default Class<XtendInterface> getSupportedType() {
		return XtendInterface.class;
	}
