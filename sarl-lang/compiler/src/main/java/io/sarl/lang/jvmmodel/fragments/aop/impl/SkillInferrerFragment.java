 ...
 * @since 0.15
 */
public class SkillInferrerFragment extends AbstractJvmModelInferrerTypeFragment implements ISkillInferrerFragment {

	@Override
	public void transform(SarlSkill source, JvmGenericType inferredJvmType, IBaseJvmModelInferrer baseInferrer) {
		...
		try {
			...
			appendConstrainedExtends(baseInferrer, context, inferredJvmType, Skill.class, SarlSkill.class, source.getExtends());
			appendConstrainedImplements(baseInferrer, context, inferredJvmType, Capacity.class, SarlCapacity.class, source.getImplements());
