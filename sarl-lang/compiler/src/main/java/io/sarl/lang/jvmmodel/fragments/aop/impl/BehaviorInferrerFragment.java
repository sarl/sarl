...
/** Fragment for inferred the behaviors to the JVM model.
 *
 ...
 * @since 0.15
 */
public class BehaviorInferrerFragment extends AbstractJvmModelInferrerTypeFragment implements IBehaviorInferrerFragment {

	@Override
	public void transform(SarlBehavior source, JvmGenericType inferredJvmType, IBaseJvmModelInferrer baseInferrer) {
		...
		try {
			...
			appendConstrainedExtends(baseInferrer, context, inferredJvmType, Behavior.class, SarlBehavior.class, source.getExtends());
