 ...
 * @since 0.15
 */
public class RequireCapacityInferrerFragment extends AbstractJvmModelInferrerFragment implements IRequireCapacityInferrerFragment {

	@Override
	public void transform(SarlRequiredCapacity source, JvmGenericType container,
