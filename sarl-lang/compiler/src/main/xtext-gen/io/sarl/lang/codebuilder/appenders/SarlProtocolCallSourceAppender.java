...
/** Source appender of a Sarl SarlProtocolCall.
	 * @see AbstractMemberBuilderFragment.java : appendTo : 194
 */
@SuppressWarnings("all")
public class SarlProtocolCallSourceAppender extends AbstractSourceAppender implements ISarlProtocolCallBuilder {

	private final ISarlProtocolCallBuilder builder;

	public SarlProtocolCallSourceAppender(ISarlProtocolCallBuilder builder) {
	...
	public void build(ISourceAppender appender) throws IOException {
		build(this.builder.getSarlProtocolCall(), appender);
	}
	...
	public SarlProtocolCall getSarlProtocolCall() {
		return this.builder.getSarlProtocolCall();
	}
