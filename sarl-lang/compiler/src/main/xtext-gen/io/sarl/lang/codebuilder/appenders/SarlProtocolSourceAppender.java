...
public class SarlProtocolSourceAppender extends AbstractSourceAppender implements ISarlProtocolBuilder {
	...
	private final ISarlProtocolBuilder builder;

	public SarlProtocolSourceAppender(ISarlProtocolBuilder builder) {
	...
	public void build(ISourceAppender appender) throws IOException {
		build(this.builder.getSarlProtocol(), appender);
	}
	...
	public SarlProtocol getSarlProtocol() {
		return this.builder.getSarlProtocol();
	}
	...
	public JvmTypeReference getSarlProtocolReference() {
		return this.builder.getSarlProtocolReference();
	}
