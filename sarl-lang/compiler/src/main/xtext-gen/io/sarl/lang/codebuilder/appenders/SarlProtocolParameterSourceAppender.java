...
/** Source appender of a Sarl SarlProtocolParameter.
	 * @see AbstractMemberBuilderFragment.java : appendTo : 194
 */
@SuppressWarnings("all")
public class SarlProtocolParameterSourceAppender extends AbstractSourceAppender implements ISarlProtocolParameterBuilder {

	private final ISarlProtocolParameterBuilder builder;

	public SarlProtocolParameterSourceAppender(ISarlProtocolParameterBuilder builder) {
	...
	public void build(ISourceAppender appender) throws IOException {
		build(this.builder.getSarlProtocolParameter(), appender);
	}
	...
	public SarlProtocolParameter getSarlProtocolParameter() {
		return this.builder.getSarlProtocolParameter();
	}
