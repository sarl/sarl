...
syn keyword sarlModifier abstract any def dispatch extension final in key native nil opt out override private protected public static strictfp synchronized transient val var volatile
syn cluster sarlTop add=sarlModifier

" keywords for the 'sarlKeyword' family.
syn keyword sarlKeyword as assert assume break case catch continue default do else extends finally fires for if implements instanceof new on parameter requires return role super switch throw throws try typeof uses while with
