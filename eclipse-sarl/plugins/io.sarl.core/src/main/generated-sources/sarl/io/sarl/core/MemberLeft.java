...
public class MemberLeft extends Event {
  ...
  public MemberLeft(final Address src, final UUID aid, final String at) {
    this.setSource(src);
    this.agentID = aid;
    this.agentType = at;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    MemberLeft other = (MemberLeft) obj;
  ...
  /**
   * Returns a String representation of the MemberLeft event's attributes only.
   */
  @Generated("io.sarl.lang.jvmmodel.SARLJvmModelInferrer")
  @Pure
