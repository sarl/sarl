...
public class AgentSpawned extends Event {
  public final UUID agentID;
  
  public final String agentType;
  
  public AgentSpawned(final Address src, final UUID aid, final String at) {
    this.setSource(src);
    this.agentID = aid;
    this.agentType = at;
  }
  ...
  /**
   * Returns a String representation of the AgentSpawned event's attributes only.
   */
  @Generated("io.sarl.lang.jvmmodel.SARLJvmModelInferrer")
  @Pure
