...
public final class SARLVersion {
	 ...
	 */
	public static final float SPECIFICATION_RELEASE_VERSION = (float) (0.4);
	 ...
	 */
	public static final String SARL_RELEASE_VERSION = "0.4.2"; //$NON-NLS-1$
	 ...
	 * @see #SARL_RELEASE_VERSION_MAVEN
	 */
	public static final String SARL_RELEASE_VERSION_OSGI = "0.4.2"; //$NON-NLS-1$
	 ...
	 * @see #SARL_RELEASE_VERSION_OSGI
	 */
	public static final String SARL_RELEASE_VERSION_MAVEN = "0.4.2"; //$NON-NLS-1$
	 ...
	 */
	public static final String MINIMAL_XTEXT_VERSION = "2.10.0"; //$NON-NLS-1$
