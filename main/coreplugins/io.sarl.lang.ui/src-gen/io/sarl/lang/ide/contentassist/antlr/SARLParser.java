		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXExponentExpressionAccess().getGroup(), "rule__XExponentExpression__Group__0");
					put(grammarAccess.getXExponentExpressionAccess().getGroup_1(), "rule__XExponentExpression__Group_1__0");
					put(grammarAccess.getXExponentExpressionAccess().getGroup_1_0(), "rule__XExponentExpression__Group_1_0__0");
					put(grammarAccess.getXExponentExpressionAccess().getGroup_1_0_0(), "rule__XExponentExpression__Group_1_0_0__0");
					...
					put(grammarAccess.getXExponentExpressionAccess().getFeatureAssignment_1_0_0_1(), "rule__XExponentExpression__FeatureAssignment_1_0_0_1");
					put(grammarAccess.getXExponentExpressionAccess().getRightOperandAssignment_1_1(), "rule__XExponentExpression__RightOperandAssignment_1_1");
