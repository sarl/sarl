 ...
 * @since 0.12
 */
public class ConcurrentSetSkipListSet<T> extends ConcurrentSkipListSet<T> implements ConcurrentSet<T> {
     ...
     */
    public ConcurrentSetSkipListSet() {
        super();
    }
     ...
     */
    public ConcurrentSetSkipListSet(Collection<? extends T> source) {
        super(source);
    }
