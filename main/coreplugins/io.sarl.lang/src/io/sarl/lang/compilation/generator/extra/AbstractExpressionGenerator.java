...
package io.sarl.lang.compilation.generator.extra;
...
import io.sarl.lang.compilation.generator.extra.ExtraLanguageFeatureNameConverter.ConversionResult;
...
public abstract class AbstractExpressionGenerator implements IExpressionGenerator {
	...
	public static String getCallSimpleName(XAbstractFeatureCall featureCall, SARLGrammarKeywordAccess keywords,
			...
			String nullKeyword,
			Function1<JvmIdentifiableElement, String> referenceNameLambda) {
		String name = null;
	 ...
	 */
	public static boolean buildCallReceiver(XAbstractFeatureCall call, Function0<String> thisKeyword,
			Function1<XExpression, String> referenceNameDefinition, List<Object> output) {
		if (call.isStatic()) {
	...
	protected abstract class FeatureCallGenerator {
		...
		private final Function0<String> thisKeyworkLambda = () -> getKeywordAccessor().getThisKeyword();

		private final Function1<XExpression, String> referenceNameLambda;

		private final Function1<JvmIdentifiableElement, String> referenceNameLambda2;
		...
		private void featureCalltoJavaExpression(XAbstractFeatureCall call, Function0<XExpression> beginOfBlock) {
			final List<Object> leftOperand = new ArrayList<>();
		...
		private void internalAppendCall(JvmIdentifiableElement calledFeature, List<Object> leftOperand,
				...
				Function0<XExpression> beginOfBlock) {
