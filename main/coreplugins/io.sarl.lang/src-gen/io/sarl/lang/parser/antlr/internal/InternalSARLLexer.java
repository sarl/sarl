...
public class InternalSARLLexer extends Lexer {
    ...
    public final void mT__98() throws RecognitionException {
        try {
            int _type = T__98;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSARL.g:84:7: ( 'case' )
            // InternalSARL.g:84:9: 'case'
            {
            match("case"); 
