...
/**
 * Wizard for creating a new SARL interface.
 *
...
public class NewSarlInterfaceWizard extends AbstractNewSarlElementWizard {
	 ...
	 */
	@Inject
	public NewSarlInterfaceWizard(IImageDescriptorHelper imgHelper, NewSarlInterfaceWizardPage page) {
		super(imgHelper, page, Messages.NewSarlInterfaceWizard_0);
	}
