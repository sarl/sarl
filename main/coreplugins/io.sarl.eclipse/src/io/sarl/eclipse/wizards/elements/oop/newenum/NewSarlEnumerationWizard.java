...
/**
 * Wizard for creating a new SARL enumeration.
 *
...
public class NewSarlEnumerationWizard extends AbstractNewSarlElementWizard {
	 ...
	 */
	@Inject
	public NewSarlEnumerationWizard(IImageDescriptorHelper imgHelper, NewSarlEnumerationWizardPage page) {
		super(imgHelper, page, Messages.NewSarlEnumerationWizard_0);
	}
