...
/**
 * Wizard for creating a new SARL class.
 *
...
public class NewSarlClassWizard extends AbstractNewSarlElementWizard {
	 ...
	 */
	@Inject
	public NewSarlClassWizard(IImageDescriptorHelper imgHelper, NewSarlClassWizardPage page) {
		super(imgHelper, page, Messages.NewSarlClassWizard_0);
	}
