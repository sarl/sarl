...
public class SuperBehaviorSelectionDialog extends AbstractSuperTypeSelectionDialog<NewSarlBehaviorWizardPage> {
	...
	@Override
	protected List<String> saveWizardPage(NewSarlBehaviorWizardPage wizardPage) {
		return Collections.singletonList(wizardPage.getSuperClass());
	}

	@Override
	protected void restoreWizardPage(NewSarlBehaviorWizardPage wizardPage, List<String> savedContent) {
	...
	@Override
	protected boolean addTypeToWizardPage(NewSarlBehaviorWizardPage wizardPage, String qualifiedName) {
		return false;
	}

	@Override
	protected int getSuperTypeCount(NewSarlBehaviorWizardPage wizardPage) {
