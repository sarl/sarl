...
public class SpaceCreated extends Event {
  public final SpaceID spaceID;
  
  public SpaceCreated(final Address src, final SpaceID sid) {
    this.setSource(src);
    this.spaceID = sid;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    SpaceCreated other = (SpaceCreated) obj;
  ...
  /**
   * Returns a String representation of the SpaceCreated event's attributes only.
   */
  @Generated("io.sarl.lang.jvmmodel.SARLJvmModelInferrer")
  @Pure
