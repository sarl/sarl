...
public class MemberJoined extends Event {
  ...
  public MemberJoined(final Address src, final UUID pid, final UUID aid, final String at) {
    this.setSource(src);
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    MemberJoined other = (MemberJoined) obj;
  ...
  /**
   * Returns a String representation of the MemberJoined event's attributes only.
   */
  @Generated("io.sarl.lang.jvmmodel.SARLJvmModelInferrer")
  @Pure
