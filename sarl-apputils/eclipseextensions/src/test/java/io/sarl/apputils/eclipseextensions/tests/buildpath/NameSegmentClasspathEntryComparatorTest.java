...
/** Tests for {@code NameSegmentClasspathEntryComparator}.
 *
...
@DisplayName("NameSegmentClasspathEntryComparator")
@Tag("unit")
public class NameSegmentClasspathEntryComparatorTest {

	private static List<IClasspathEntry> entries;

	private static String[] expected;

	private NameSegmentClasspathEntryComparator comparator;
	...
	public static void globalSetUp() throws Exception {
		...
		expected = Arrays.asList(
				...
				"src/test/sarl",
				"src/x/y/z",
				"x/y/z").toArray(size -> new String[size]);
	...
	public void setUp() throws Exception {
		this.comparator = new NameSegmentClasspathEntryComparator();
	}
