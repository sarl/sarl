...
package io.sarl.pythongenerator;
 ...
 */
public class PyGeneratorPlugin extends AbstractUIPlugin {

	/** Identifier of the plugin.
	 */
	public static final String PLUGIN_ID = "io.sarl.pythongenerator.plugin"; //$NON-NLS-1$
