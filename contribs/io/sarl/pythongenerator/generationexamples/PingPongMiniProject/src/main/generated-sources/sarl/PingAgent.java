...
public class PingAgent extends Agent {
  private pingingBehavior pingBehavior;
  
  private pongListen pongListenBehavior;
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    pingingBehavior _pingingBehavior = new pingingBehavior(this, spc);
    this.pingBehavior = _pingingBehavior;
    Behaviors _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER_1 = this.$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER_1.registerBehavior(this.pingBehavior);
    pongListen _pongListen = new pongListen(this, spc);
    this.pongListenBehavior = _pongListen;
    Behaviors _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER_2 = this.$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER_2.registerBehavior(this.pongListenBehavior);
  }
  
  private void $behaviorUnit$Destroy$1(final Destroy occurrence) {
    Behaviors _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER = this.$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER.unregisterBehavior(this.pingBehavior);
    Behaviors _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER_1 = this.$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER();
    _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER_1.unregisterBehavior(this.pongListenBehavior);
  }
