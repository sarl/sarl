...
public class PingAgent extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    final AgentTask tsk = _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER.task("pongwait");
    DefaultContextInteractions _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1 = this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER();
    InputOutput.<Integer>println(Integer.valueOf(_$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1.getDefaultSpace().getNumberOfStrongParticipants()));
    ...
    final Procedure1<Agent> _function = (Agent it) -> {
      ...
      int _numberOfStrongParticipants = _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_2.getDefaultSpace().getNumberOfStrongParticipants();
      if ((_numberOfStrongParticipants > 1)) {
        PingEvent e = new PingEvent(0);
        InputOutput.<String>println("Sending intial ping event");
        ExternalContextAccess _$CAPACITY_USE$IO_SARL_CORE_EXTERNALCONTEXTACCESS$CALLER = this.$CAPACITY_USE$IO_SARL_CORE_EXTERNALCONTEXTACCESS$CALLER();
        _$CAPACITY_USE$IO_SARL_CORE_EXTERNALCONTEXTACCESS$CALLER.emit(this.spc, e);
        Schedules _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER_2 = this.$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER();
        _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER_2.cancel(tsk);
      } else {
  ...
  private void $behaviorUnit$PongEvent$1(final PongEvent occurrence) {
    InputOutput.<String>println("Received pong event");
    PingEvent e = new PingEvent((occurrence.index + 1));
    ExternalContextAccess _$CAPACITY_USE$IO_SARL_CORE_EXTERNALCONTEXTACCESS$CALLER = this.$CAPACITY_USE$IO_SARL_CORE_EXTERNALCONTEXTACCESS$CALLER();
  ...
  private void $guardEvaluator$PongEvent(final PongEvent occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$PongEvent$1(occurrence));
  }
