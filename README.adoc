...
image:https://img.shields.io/maven-central/v/io.sarl.maven/io.sarl.maven.sdk.svg?label=Maven%20Central[link=http://search.maven.org/#search%7Cga%7C1%7Cio.sarl]
...
* link:./formatting-styles/gnusrchighlite/sarl.lang[GNU src-highlite]
...
* Mohamed Ezzat, code cleaning and optimization.
