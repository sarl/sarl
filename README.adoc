...
image:https://ci.appveyor.com/api/projects/status/github/gallandarakhneorg/sarl?branch=master&svg=true[link=https://ci.appveyor.com/project/gallandarakhneorg/sarl]
