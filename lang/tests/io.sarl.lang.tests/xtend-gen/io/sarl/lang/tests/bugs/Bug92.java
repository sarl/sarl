...
public class Bug92 {
  ...
  public void originialCode_withDoubleType() {
    try {
      ...
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("public abstract Double getEnergy(final Double currentTime, final Double deltaTime, final Double wantedEnergy);");
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.newLine();
      _builder_1.append("  ");
      _builder_1.append("public abstract void setVoltage(final Double currentVoltage);");
      _builder_1.newLine();
      _builder_1.append("}");
      _builder_1.newLine();
      ...
      _builder_2.newLine();
      _builder_2.append("   ");
      _builder_2.append("* Construct an agent.");
      _builder_2.newLine();
      _builder_2.append("   ");
      _builder_2.append("* @param parentID - identifier of the parent. It is the identifer");
      _builder_2.newLine();
      _builder_2.append("   ");
      _builder_2.append("* of the parent agent and the enclosing contect, at the same time.");
      _builder_2.newLine();
      _builder_2.append("   ");
      _builder_2.append("* ");
      _builder_2.newLine();
      ...
      _builder_2.newLine();
      _builder_2.append("  ");
      _builder_2.append("protected Double getEnergy(final Double currentTime, final Double deltaTime, final Double wantedEnergy) {");
      _builder_2.newLine();
      _builder_2.append("    ");
      ...
      _builder_2.newLine();
      _builder_2.append("  ");
      _builder_2.append("protected void setVoltage(final Double currentVoltage) {");
      _builder_2.newLine();
      _builder_2.append("    ");
      ...
      _builder_3.append("import io.sarl.lang.annotation.Generated;");
      _builder_3.newLine();
      ...
      _builder_3.newLine();
      _builder_3.append("   ");
      _builder_3.append("* Construct an agent.");
      _builder_3.newLine();
      _builder_3.append("   ");
      _builder_3.append("* @param parentID - identifier of the parent. It is the identifer");
      _builder_3.newLine();
      _builder_3.append("   ");
      _builder_3.append("* of the parent agent and the enclosing contect, at the same time.");
      _builder_3.newLine();
      _builder_3.append("   ");
      _builder_3.append("* ");
      _builder_3.newLine();
