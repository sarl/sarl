...
:
(
{ before(grammarAccess.getActionSignatureAccess().getRightParenthesisKeyword_2_3()); }

	')' 

{ after(grammarAccess.getActionSignatureAccess().getRightParenthesisKeyword_2_3()); }
)
