...
public enum Addresses {
	...
	/** Replies the Json string representation of this addresses.
	 *
	...
	/** Parse the given case insensitive string for obtaining the addresses.
	 *
	...
	@JsonCreator
	@Pure
	public static Addresses valueOfCaseInsensitive(String name) {
		...
		try {
			for (final Addresses expr : values()) {
	...
	/** Replies the Json labels for the addresses.
	 *
	 * @return the labels.
	 */
	@Pure
