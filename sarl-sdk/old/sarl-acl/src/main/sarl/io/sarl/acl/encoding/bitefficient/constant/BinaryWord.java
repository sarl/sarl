...
public enum BinaryWord {
	...
	/** Replies the Json string representation of this word.
	 *
	...
	/** Parse the given case insensitive string for obtaining the word.
	 *
	...
	@JsonCreator
	@Pure
	public static BinaryWord valueOfCaseInsensitive(String name) {
		...
		try {
			for (final BinaryWord expr : values()) {
	...
	/** Replies the Json labels for the word.
	 *
	 * @return the labels.
	 */
	@Pure
