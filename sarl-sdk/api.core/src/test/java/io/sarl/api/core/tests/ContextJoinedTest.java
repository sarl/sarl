...
public class ContextJoinedTest extends AbstractSarlCoreTest<Event> {
	...
	@BeforeEach
	public void setUp() {
		loadSARL("io.sarl.api.core.ContextJoined", Event.class); //$NON-NLS-1$
	}
	 ...
	 */
	@Test
	public void defaultSpaceID() {
		assertField("defaultSpaceID", UUID.class); //$NON-NLS-1$
	}
	...
	public void constructor() {
		assertConstructor(UUID.class, UUID.class);
	}
