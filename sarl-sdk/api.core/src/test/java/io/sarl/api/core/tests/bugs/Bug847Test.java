...
public class Bug847Test extends AbstractSarlTest {
	...
	private static final String EXPECTED01 = multilineString2(false,
			"package io.sarl.lang.tests.bug847;",
			"",
			"import io.sarl.api.core.AgentSpawned;",
			"import io.sarl.api.core.Logging;",
			...
			"    _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER.info(\"Agent {0} of type {1} has been created successfully and is now alive!\", ",
			"      occurrence.agentID, occurrence.agentType);",
			"  }",
			"",
			"  @Extension",
			...
			"    if (AgentSpawned.class.equals(eventType)) {",
			"      final var occurrence = (AgentSpawned) event;",
	...
	private static final String EXPECTED02 = multilineString2(false,
			"package io.sarl.lang.tests.bug847;",
			"",
			"import io.sarl.api.core.AgentSpawned;",
			"import io.sarl.api.core.Logging;",
			...
			"    Logging _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER = this.$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER();",
			"    _$CAPACITY_USE$IO_SARL_API_CORE_LOGGING$CALLER.info(\"Agent {0} of type {1} has been created successfully and is now alive!\", agent_id, agent_type);",
			"  }",
			"",
			"  @Extension",
			"  @ImportedCapacityFeature(Logging.class)",
