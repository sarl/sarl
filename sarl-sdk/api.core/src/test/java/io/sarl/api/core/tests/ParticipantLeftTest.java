 ...
 */
@DisplayName("ParticipantLeft")
@Tag("unit")
@Tag("api")
public class ParticipantLeftTest extends AbstractSarlCoreTest<Event> {

	/**
	 */
	@BeforeEach
	public void setUp() {
		loadSARL("io.sarl.api.core.ParticipantLeft", Event.class); //$NON-NLS-1$
	}
