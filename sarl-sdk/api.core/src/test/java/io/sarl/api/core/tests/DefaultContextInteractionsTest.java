...
public class DefaultContextInteractionsTest extends AbstractSarlCoreTest<Capacity> {
	...
	@BeforeEach
	public void setUp() {
		loadSARL("io.sarl.api.core.DefaultContextInteractions", Capacity.class); //$NON-NLS-1$
	}
	...
	public void memberCount() {
		...
		assertEquals(15+1+1, this.type.getDeclaredMethods().length, "number of methods"); //$NON-NLS-1$
	}
