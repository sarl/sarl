...
/**
 * This enumeration describes all available constant for EndOfMessage/EndOfCollection as defined by FIPA for Bit-Efficient encoding, 
...
public enum EndOfMessage {

	/** End of message.
	 * 
	 * <p>Code: {@code 0x01}.
	 */
	END_OF_MESSAGE((byte) 0x01);
	
	private final byte code;
	
	private EndOfMessage(byte code) {
		this.code = code;
	}
	...
	@JsonCreator
	@Pure
	public static EndOfMessage valueOfCaseInsensitive(String name) {
		...
		try {
			for (final EndOfMessage expr : values()) {
