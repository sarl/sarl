...
public class Bug1035Test extends AbstractSarlTest {
	...
	private final String JAVA_CODE_01 = multilineString(
			...
			"  private static final boolean $DEFAULT_VALUE$SYNCOUT_0 = false;",
			"  ",
			"  /**",
			...
			"  @SyntheticMember",
			"  @SarlSourceCode(\"null\")",
			"  private static final Procedure2 $DEFAULT_VALUE$SYNCOUT_1 = null;",
			"  ",
	...
	private final String JAVA_CODE_02 = multilineString(
			...
			"  private static final Procedure2 $DEFAULT_VALUE$SYNCOUT_1 = null;",
			"  ",
			"  @DefaultValueUse(\"T,boolean,(T, T)=>void\")",
			"  @SyntheticMember",
