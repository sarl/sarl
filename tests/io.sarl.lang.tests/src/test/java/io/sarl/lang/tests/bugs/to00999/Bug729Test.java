...
public class Bug729Test extends AbstractSarlTest {
	...
	private final String EXPECTED1 = multilineString(
			...
			"import io.sarl.lang.tests.bug729.Scope;",
			"import io.sarl.lang.tests.bug729.Scopes;", 
			"", 
			...
			"  static final Scope $DEFAULT_VALUE$FIRSTEXAMPLEMETHOD_0 = Scopes.<Address>allParticipants();", 
			"  ", 
			"  @DefaultValueSource", 
			...
			"  @SyntheticMember", 
			"  @SarlSourceCode(\"true\")", 
			"  static final boolean $DEFAULT_VALUE$SECONDEXAMPLEMETHOD_0 = true;", 
			"  ", 
			"  @DefaultValueUse(\"io.sarl.lang.tests.bug729.Scope<io.sarl.lang.core.Address>\")", 
			"  @SyntheticMember", 
	...
	private final String EXPECTED2 = multilineString(
			...
			"  @SyntheticMember", 
			"  @SarlSourceCode(\"\\\"\\\"\")", 
			"  static final String $DEFAULT_VALUE$SECONDEXAMPLEMETHOD_0 = \"\";", 
			"  ", 
			"  @DefaultValueUse(\"io.sarl.lang.tests.bug729.Scope<io.sarl.lang.core.Address>\")", 
			"  @SyntheticMember", 
			"  default void firstExampleMethod() {", 
	...
	private final String EXPECTED5 = multilineString(
			...
			"  @SyntheticMember", 
			"  @SarlSourceCode(\"Scopes.<Address>allParticipants\")", 
			"  static final Scope $DEFAULT_VALUE$FIRSTEXAMPLEMETHOD_1 = Scopes.<Address>allParticipants();", 
			"  ", 
			"  @DefaultValueSource", 
			"  void secondExampleMethod(@DefaultValue(\"io.sarl.lang.tests.bug729.Example#SECONDEXAMPLEMETHOD_0\") final boolean paramWithDefault);", 
			"  ", 
			...
			"  }", 
			"  ", 
			"  @DefaultValueUse(\"int,io.sarl.lang.tests.bug729.Scope<io.sarl.lang.core.Address>\")", 
			"  @SyntheticMember", 
	...
	private final String EXPECTED6 = multilineString(
			...
			"  static final String $DEFAULT_VALUE$SECONDEXAMPLEMETHOD_0 = new String();", 
			"  ", 
			"  @DefaultValueUse(\"io.sarl.lang.tests.bug729.Scope<io.sarl.lang.core.Address>\")", 
			"  @SyntheticMember", 
			"  default void firstExampleMethod() {", 
