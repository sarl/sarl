	...
	public class CapacityTest extends AbstractSarlTest {
		...
		public void capacity() throws Exception {
			...
			String expected = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"45\")",
					"  static final int $DEFAULT_VALUE$MYACTION_0 = 45;",
					"  ",
					"  /**",
					"   * Default value for the parameter arg1",
					"   */",
					"  @SyntheticMember",
					"  @SarlSourceCode(\"56\")",
					"  static final int $DEFAULT_VALUE$MYACTION_1 = 56;",
					"  ",
					"  /**",
					"   * Default value for the parameter arg3",
					"   */",
					"  @SyntheticMember",
					"  @SarlSourceCode(\"14\")",
					"  static final int $DEFAULT_VALUE$MYACTION_2 = 14;",
					"  ",
					"  @DefaultValueUse(\"int,int,int,int\")",
					"  @SyntheticMember",
	...
	public class SkillTest extends AbstractSarlTest {
		...
		public void missedActionImplementation() throws Exception {
			final String expectedC1 = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"4\")",
					"  static final int $DEFAULT_VALUE$MYACTION1_0 = 4;",
					"  ",
					"  @DefaultValueUse(\"int\")",
					"  @SyntheticMember",
			...
			final String expectedC2 = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"6\")",
					"  static final float $DEFAULT_VALUE$MYACTION2_0 = 6;",
					"  ",
