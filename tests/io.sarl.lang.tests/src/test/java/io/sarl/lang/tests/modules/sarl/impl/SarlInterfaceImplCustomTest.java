...
@DisplayName("ecore: custom SarlInterface")
@Tag("core")
@Tag("unit")
public class SarlInterfaceImplCustomTest extends AbstractSarlTest {
	...
	public void default_visibility_in_agent() throws Exception {
		this.agent.getMembers().add(this.interfaceType);
	...
	public void default_visibility_in_capacity() throws Exception {
		this.capacity.getMembers().add(this.interfaceType);
		assertEquals(JvmVisibility.PUBLIC, this.interfaceType.getVisibility());
	}
	...
	public void default_visibility_in_class() throws Exception {
		this.clazz.getMembers().add(this.interfaceType);
		assertEquals(JvmVisibility.PUBLIC, this.interfaceType.getVisibility());
	}
