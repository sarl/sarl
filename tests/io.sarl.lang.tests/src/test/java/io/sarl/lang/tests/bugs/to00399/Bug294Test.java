	...
	public class CompilerTests extends AbstractSarlTest {
		...
		public void testCompiler() throws Exception {
			final String expectedPhysicEnvironment = multilineString(
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"null\")",
					"  static final String $DEFAULT_VALUE$INFLUENCEKINEMATIC_0 = null;",
					"  ",
					"  /**",
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"0f\")",
					"  static final float $DEFAULT_VALUE$INFLUENCEKINEMATIC_1 = 0f;",
					"  ",
					"  @DefaultValueSource",
					...
					"  @SyntheticMember",
					"  @SarlSourceCode(\"null\")",
					"  static final String $DEFAULT_VALUE$INFLUENCESTEERING_0 = null;",
					"  ",
					"  /**",
					"   * Default value for the parameter angularInfluence",
					"   */",
					"  @SyntheticMember",
					"  @SarlSourceCode(\"0f\")",
					"  static final float $DEFAULT_VALUE$INFLUENCESTEERING_1 = 0f;",
					"  ",
