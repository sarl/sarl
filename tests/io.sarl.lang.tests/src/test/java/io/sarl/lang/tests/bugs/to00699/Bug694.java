...
public class Bug694 extends AbstractSarlTest {
	...
	private final String EXPECTED1 = multilineString(
			...
			"  }",
			"  ",
			"  @Inline(value = \"6.0f\", constantExpression = true)",
			"  @Pure",
			...
			"  }",
			"  ",
			"  public int myfunction05(final float p) {",
			"    return this.f = ((int) p);",
			"  }",
			"  ",
			"  @Pure",
			...
			"  }",
			"  ",
			"  public int myfunction07(final float p) {",
			"    return this.myfunction05(p);",
			"  }",
			"  ",
			"  @Pure",
	...
	private final String EXPECTED2_2 = multilineString(
			...
			"  @Inline(value = \"7.0f\", constantExpression = true)",
			"  @Pure",
			"  public float myfunction00() {",
			"    return 7;",
			"  }",
