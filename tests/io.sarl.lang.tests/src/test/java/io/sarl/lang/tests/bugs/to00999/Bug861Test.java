...
public class Bug861Test extends AbstractSarlTest {
	...
	private static final String EXPECTED_BOOTAGENT_01 = multilineString(
		...
		"  @SyntheticMember",
		"  private transient AtomicClearableReference<Skill> $CAPACITY_USE$IO_SARL_CORE_LIFECYCLE;",
		"  ",
		"  @SyntheticMember",
		"  @Pure",
		...
		"  @SyntheticMember",
		"  private transient AtomicClearableReference<Skill> $CAPACITY_USE$IO_SARL_CORE_LOGGING;",
		"  ",
		"  @SyntheticMember",
		"  @Pure",
