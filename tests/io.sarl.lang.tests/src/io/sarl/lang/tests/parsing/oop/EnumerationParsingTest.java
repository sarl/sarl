	...
	public static class InsideAgentTest extends AbstractSarlTest {
		...
		public void classmodifier_public() throws Exception {
			...
			validate(mas).assertError(
					...
					org.eclipse.xtend.core.validation.IssueCodes.INVALID_MODIFIER,
					64, 6,
					"Illegal modifier for the enumeration E1; only package, protected, private & static are permitted");
		}
		...
		public void classmodifier_public_package() throws Exception {
			...
			validate(mas).assertError(
				...
				org.eclipse.xtend.core.validation.IssueCodes.INVALID_MODIFIER,
				71, 7,
				"The enumeration E1 can only set one of public / package / protected / private");
		}
