	...
	public static class AgentTest extends AbstractSarlTest {
		...
		public void action_5p_1() throws Exception {
			...
			String expected = multilineString(
					...
					"public class A1 extends Agent {",
					"  @DefaultValueSource",
					"  protected void myaction(final int arg0, @DefaultValue(\"A1#MYACTION_1\") final String arg1, final int arg2, final int arg3, final String arg4) {",
					"    System.out.println(arg0);",
					"  }",
					"  ",
					"  /**",
		...
		public void action_5p_2() throws Exception {
			...
			String expected = multilineString(
					...
					"public class A1 extends Agent {",
					"  @DefaultValueSource",
					"  protected void myaction(final int arg0, final String arg1, @DefaultValue(\"A1#MYACTION_2\") final int arg2, final int arg3, final String arg4) {",
					"    System.out.println(arg0);",
					"  }",
					"  ",
					"  /**",
		...
		public void action_5p_3() throws Exception {
			...
			String expected = multilineString(
					...
					"public class A1 extends Agent {",
					"  @DefaultValueSource",
					"  protected void myaction(final int arg0, final String arg1, final int arg2, @DefaultValue(\"A1#MYACTION_3\") final int arg3, final String arg4) {",
					"    System.out.println(arg0);",
					"  }",
					"  ",
					"  /**",
		...
		public void action_5p_4() throws Exception {
			...
			String expected = multilineString(
					...
					"public class A1 extends Agent {",
					"  @DefaultValueSource",
					"  protected void myaction(final int arg0, final String arg1, final int arg2, final int arg3, @DefaultValue(\"A1#MYACTION_4\") final String arg4) {",
					"    System.out.println(arg0);",
					"  }",
					"  ",
					"  /**",
		...
		public void action_5p_0_3() throws Exception {
			...
			String expected = multilineString(
					...
					"public class A1 extends Agent {",
					"  @DefaultValueSource",
					"  protected void myaction(@DefaultValue(\"A1#MYACTION_0\") final int arg0, final String arg1, final int arg2, @DefaultValue(\"A1#MYACTION_3\") final int arg3, final String arg4) {",
					"    System.out.println(arg0);",
					"  }",
					"  ",
					"  /**",
		...
		public void action_3p_vararg_1() throws Exception {
			...
			String expected = multilineString(
					...
					"public class A1 extends Agent {",
					"  @DefaultValueSource",
					"  protected void myaction(final int arg0, @DefaultValue(\"A1#MYACTION_1\") final int arg1, final int... arg2) {",
					"    System.out.println(arg0);",
					"  }",
					"  ",
					"  /**",
		...
		public void action_3p_vararg_returnValue() throws Exception {
			...
			String expected = multilineString(
					...
					"public class A1 extends Agent {",
					"  @DefaultValueSource",
					"  protected boolean myaction(final int arg0, @DefaultValue(\"A1#MYACTION_1\") final int arg1, final int... arg2) {",
					"    System.out.println(arg0);",
					"    return true;",
					"  }",
					"  ",
