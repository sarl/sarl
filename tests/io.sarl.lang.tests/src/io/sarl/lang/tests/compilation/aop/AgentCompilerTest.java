...
public class AgentCompilerTest extends AbstractSarlTest {
	...
	public void inlinedCapacityFunctionCall_nativeParameter() throws Exception {
		...
		final String expectedA1 = multilineString(
				...
				"    C1 _$CAPACITY_USE$C1$CALLER = this.$CAPACITY_USE$C1 == null ? (this.$CAPACITY_USE$C1 = getSkill(C1.class)) : this.$CAPACITY_USE$C1;",
	...
	public void inlinedCapacityFunctionCall_variadicParameter01() throws Exception {
		...
		final String expectedA1 = multilineString(
			    ...
			    "    C1 _$CAPACITY_USE$C1$CALLER = this.$CAPACITY_USE$C1 == null ? (this.$CAPACITY_USE$C1 = getSkill(C1.class)) : this.$CAPACITY_USE$C1;",
				"    _$CAPACITY_USE$C1$CALLER.myfunction(Integer.class);",
				"    C1 _$CAPACITY_USE$C1$CALLER_1 = this.$CAPACITY_USE$C1 == null ? (this.$CAPACITY_USE$C1 = getSkill(C1.class)) : this.$CAPACITY_USE$C1;",
				"    _$CAPACITY_USE$C1$CALLER_1.myfunction(Float.class, 1);",
				"    C1 _$CAPACITY_USE$C1$CALLER_2 = this.$CAPACITY_USE$C1 == null ? (this.$CAPACITY_USE$C1 = getSkill(C1.class)) : this.$CAPACITY_USE$C1;",
				"    _$CAPACITY_USE$C1$CALLER_2.myfunction(String.class, 2, 3);",
				"    C1 _$CAPACITY_USE$C1$CALLER_3 = this.$CAPACITY_USE$C1 == null ? (this.$CAPACITY_USE$C1 = getSkill(C1.class)) : this.$CAPACITY_USE$C1;",
	...
	public void usePureCapacityFunction() throws Exception {
		...
		final String expectedMyAgent = multilineString(
				...
				"    C1 _$CAPACITY_USE$FOO_TEST_C1$CALLER = this.$CAPACITY_USE$FOO_TEST_C1 == null ? (this.$CAPACITY_USE$FOO_TEST_C1 = getSkill(C1.class)) : this.$CAPACITY_USE$FOO_TEST_C1;",
				...
				"  @ImportedCapacityFeature(C1.class)",
				"  @SyntheticMember",
				"  private transient C1 $CAPACITY_USE$FOO_TEST_C1;",
				"  ",
				"  @Inline(value = \"$CAPACITY_USE$FOO_TEST_C1 == null ? (this.$CAPACITY_USE$FOO_TEST_C1 = getSkill(C1.class)) : this.$CAPACITY_USE$FOO_TEST_C1\")",
				"  @SyntheticMember",
				"  private C1 $CAPACITY_USE$FOO_TEST_C1$CALLER() {",
				"    if (this.$CAPACITY_USE$FOO_TEST_C1 == null) {",
				"      this.$CAPACITY_USE$FOO_TEST_C1 = getSkill(C1.class);",
				"    }",
				"    return this.$CAPACITY_USE$FOO_TEST_C1;",
				"  }",
				"  ",  
				"  /**",
				"   * Construct an agent.",
				...
				"  @Override",
				"  protected <S extends Skill> S $setSkill(final S skill, final Class<? extends Capacity>... capacities) {",
				"    this.$CAPACITY_USE$FOO_TEST_C1 = null;",
				"    return super.$setSkill(skill, capacities);",
				"  }",
				"  ",  
				"  @SyntheticMember",
