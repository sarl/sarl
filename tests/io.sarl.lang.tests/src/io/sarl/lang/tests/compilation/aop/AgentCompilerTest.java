...
public class AgentCompilerTest extends AbstractSarlTest {
	...
	public void inlinedCapacityFunctionCall_variadicParameter02() throws Exception {
		...
		final String expectedA1 = multilineString(
				...
				"public class A1 extends Agent {",
				"  protected void caller() {",
				"    this.getSkill(C1.class).myfunction((int[])null);",
				"    this.getSkill(C1.class).myfunction(1);",
				"    this.getSkill(C1.class).myfunction(2, 3);",
				"    this.getSkill(C1.class).myfunction(new int[] {});",
				"  }",
				"  ",
				"  /**",
				"   * See the capacity {@link C1#myfunction(int[])}.",
				"   * ",
				"   * @see C1#myfunction(int[])",
				"   */",
				"  @Inline(value = \"getSkill(C1.class).myfunction($1)\", imported = C1.class)",
				"  @Generated(\"io.sarl.lang.jvmmodel.SARLJvmModelInferrer\")",
				"  @ImportedCapacityFeature(C1.class)",
				"  private void myfunction(final int... v2) {",
				"    getSkill(C1.class).myfunction(v2);",
				"  }",
				"  ",
				"  /**",
				"   * Construct an agent.",
