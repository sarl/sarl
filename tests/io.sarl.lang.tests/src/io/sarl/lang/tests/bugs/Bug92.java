...
public class Bug92 extends AbstractSarlTest {
	...
	public void attributeDeclarationCompiler_Double() throws Exception {
		this.compiler.assertCompilesTo(
				...
				multilineString(
						...
						"        return false;",
						"    } else if (!this.myDouble.equals(other.myDouble))",
						"      return false;",
						"    return super.equals(obj);",
						"  }",
						"  ",
						...
						"    final int prime = 31;",
						"    int result = super.hashCode();",
						"    result = prime * result + ((this.myDouble== null) ? 0 : this.myDouble.hashCode());",
						"    return result;",
						"  }",
						"  ",
						"  @SyntheticMember",
	...
	public void originialCode_withDoubleType() throws Exception {
		...
		final String expected2 = multilineString(
				...
				"        return false;",
				"    } else if (!this.busTime.equals(other.busTime))",
				"      return false;",
				"    if (this.wantedIntensity == null) {",
				"      if (other.wantedIntensity != null)",
				"        return false;",
				"    } else if (!this.wantedIntensity.equals(other.wantedIntensity))",
				"      return false;",
				"    return super.equals(obj);",
				"  }",
				"  ",
				...
				"    final int prime = 31;",
				"    int result = super.hashCode();",
				"    result = prime * result + ((this.busTime== null) ? 0 : this.busTime.hashCode());",
				"    result = prime * result + ((this.wantedIntensity== null) ? 0 : this.wantedIntensity.hashCode());",
				"    return result;",
				"  }",
				"  ",
				"  @SyntheticMember",
