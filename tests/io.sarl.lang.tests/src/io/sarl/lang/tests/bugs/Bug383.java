	...
	public static class CompilerTest extends AbstractSarlTest {
		...
		public void compilation() throws Exception {
			final String expected = multilineString(
					...
					"  @SarlSourceCode(\" null\")",
					"  private final static String ___FORMAL_PARAMETER_DEFAULT_VALUE_GETINSTANCE_0 = null;",
					"  ",
					"  /**",
					"   * Testing documentation generator.",
					"   * @param type the type.",
					...
					"    return getInstance(type, ___FORMAL_PARAMETER_DEFAULT_VALUE_GETINSTANCE_0);",
					"  }",
					"  ",
					"  /**",
					"   * Construct an agent.",
