...
@RunWith(Suite.class)
@SuiteClasses({
	PrimitiveByteArithmeticExtensionsTest.Code.class,
	PrimitiveByteArithmeticExtensionsTest.Compilation.class
})
@SuppressWarnings("all")
public class PrimitiveByteArithmeticExtensionsTest {
