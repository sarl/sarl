...
public class MergedMapsTest extends Assert {
	...
	public void setUp() {
		...
		this.left.put("b", "vb");
		this.left.put("c", "vc");
		this.right1 = new HashMap<>();
		this.right1.put("d", "vd");
		this.right1.put("b", "vb2");
		this.right2 = new HashMap<>();
		this.right2.put("d", "vd");
		this.map0 = SARLMapExtensions.union(Collections.<String, String>emptyMap(), Collections.<String, String>emptyMap());
		this.map1 = SARLMapExtensions.union(this.left, this.right1);
		this.map2 = SARLMapExtensions.union(this.left, this.right2);
		this.map3 = SARLMapExtensions.union(this.left, Collections.<String, String>emptyMap());
	}
