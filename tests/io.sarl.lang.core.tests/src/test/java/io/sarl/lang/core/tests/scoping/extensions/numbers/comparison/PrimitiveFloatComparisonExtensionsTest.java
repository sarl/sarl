...
@RunWith(Suite.class)
@SuiteClasses({
	PrimitiveFloatComparisonExtensionsTest.Code.class,
	PrimitiveFloatComparisonExtensionsTest.Compilation.class
})
@SuppressWarnings("all")
public class PrimitiveFloatComparisonExtensionsTest {
