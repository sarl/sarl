...
import static io.sarl.lang.scoping.extensions.numbers.arithmetic.NumberArithmeticExtensions.*;
...
@RunWith(Suite.class)
@SuiteClasses({
	NumberArithmeticExtensionsTest.Code.class,
	NumberArithmeticExtensionsTest.Compilation.class
})
@SuppressWarnings("all")
public class NumberArithmeticExtensionsTest {
