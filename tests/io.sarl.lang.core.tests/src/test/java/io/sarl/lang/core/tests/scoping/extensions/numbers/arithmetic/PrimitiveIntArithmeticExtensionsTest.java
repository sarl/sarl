...
@RunWith(Suite.class)
@SuiteClasses({
	PrimitiveIntArithmeticExtensionsTest.Code.class,
	PrimitiveIntArithmeticExtensionsTest.Compilation.class
})
@SuppressWarnings("all")
public class PrimitiveIntArithmeticExtensionsTest {
