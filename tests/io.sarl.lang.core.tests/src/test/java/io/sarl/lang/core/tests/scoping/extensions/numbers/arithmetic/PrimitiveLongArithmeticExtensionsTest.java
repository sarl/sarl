...
@RunWith(Suite.class)
@SuiteClasses({
	PrimitiveLongArithmeticExtensionsTest.Code.class,
	PrimitiveLongArithmeticExtensionsTest.Compilation.class
})
@SuppressWarnings("all")
public class PrimitiveLongArithmeticExtensionsTest {
