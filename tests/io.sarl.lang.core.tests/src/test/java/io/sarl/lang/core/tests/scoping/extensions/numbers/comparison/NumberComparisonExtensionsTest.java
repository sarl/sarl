...
import static io.sarl.lang.scoping.extensions.numbers.comparison.NumberComparisonExtensions.*;
...
@RunWith(Suite.class)
@SuiteClasses({
	NumberComparisonExtensionsTest.Code.class,
	NumberComparisonExtensionsTest.Compilation.class
})
@SuppressWarnings("all")
public class NumberComparisonExtensionsTest {
