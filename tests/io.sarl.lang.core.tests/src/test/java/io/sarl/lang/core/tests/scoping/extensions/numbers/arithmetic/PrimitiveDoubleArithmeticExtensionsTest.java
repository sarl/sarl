...
@RunWith(Suite.class)
@SuiteClasses({
	PrimitiveDoubleArithmeticExtensionsTest.Code.class,
	PrimitiveDoubleArithmeticExtensionsTest.Compilation.class
})
@SuppressWarnings("all")
public class PrimitiveDoubleArithmeticExtensionsTest {
