...
public class AgentOutlineTest extends AbstractSARLOutlineTreeProviderTest {
	...
	public void test1Attribute() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { var attr : boolean }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
	...
	public void test2Attributes() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { val xyz : float var attr : boolean }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
		a = asserts.child(0, "A1"); //$NON-NLS-1$
		a.numChildren(2);
	...
	public void test1Action_0() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { def operation : boolean {true} }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
		a = asserts.child(0, "A1"); //$NON-NLS-1$
		a.numChildren(1);
	...
	public void test1Action_1() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { def operation(a : float) {} }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
		a = asserts.child(0, "A1"); //$NON-NLS-1$
		a.numChildren(1);
	...
	public void test1Action_2() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { def operation(a : float) : int {1} }"); //$NON-NLS-1$
		asserts.numChildren(1);
		asserts.child(0, "A1") //$NON-NLS-1$
			.leaf(0, "operation(float) : int"); //$NON-NLS-1$
	}
	...
	public void test2Actions_0() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { def xyz : boolean {true} def abc : float {1.0} }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
		a = asserts.child(0, "A1"); //$NON-NLS-1$
		a.numChildren(2);
	...
	public void test2Actions_1() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { def xyz(b : char) : boolean {true} def abc : float {1.0} }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
		a = asserts.child(0, "A1"); //$NON-NLS-1$
		a.numChildren(2);
	...
	public void test1BehaviorUnit_0() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { on io.sarl.lang.core.Event {} }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
		a = asserts.child(0, "A1"); //$NON-NLS-1$
		a.numChildren(1);
	...
	public void test1BehaviorUnit_1() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { on io.sarl.lang.core.Event [true] {} }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
		a = asserts.child(0, "A1"); //$NON-NLS-1$
		a.numChildren(1);
	...
	public void test2BehaviorUnits() throws Exception {
		OutlineAsserts asserts = newOutlineAsserts(
				"agent A1 { on io.sarl.lang.core.Event [true] {} on io.sarl.lang.core.Event {} }"); //$NON-NLS-1$
		asserts.numChildren(1);
		OutlineAsserts a;
		a = asserts.child(0, "A1"); //$NON-NLS-1$
		a.numChildren(2);
