...
/** Generate the documentation for a type.
 *
 ...
 * @since 0.13
 */
public interface TypeDocumentationGenerator {

	/** Generate the documentation.
	 *
	 * @param type is the type for which the documentation should be generated.
	 ...
	 */
	void generate(TypeElement type, Collection<Path> cssStylesheets, Collection<Path> jsScripts, SarlDocletEnvironment environment, DocletOptions cliOptions, Reporter reporter) throws Exception;
