...
/** Taglet for {@code privateapi} tag.
 *
 ...
 * @since 0.13
 */
public class PrivateApiTaglet extends AbstractSarlTaglet {

	/** Name of the tag.
	 */
	public static final String TAGLET_NAME = "privateapi"; //$NON-NLS-1$

	/** Constructor.
	 */
	public PrivateApiTaglet() {
	...
	protected CssStyles getTextCssStyle(CssStyles original) {
		return CssStyles.TAG_PRIVATEAPI_COMMENT;
	}
