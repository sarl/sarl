 ...
 * @since 0.13
 */
public class UsesTaglet extends AbstractSarlTaglet {

	/** Name of the tag.
	 */
	public static final String TAGLET_NAME = "uses"; //$NON-NLS-1$

	/** Constructor.
	 */
	public UsesTaglet() {
		super(TAGLET_NAME.toLowerCase(), false, Location.MODULE);
	}
	...
	protected CssStyles getTextCssStyle(CssStyles original) {
		return CssStyles.TAG_USES_COMMENT;
	}
