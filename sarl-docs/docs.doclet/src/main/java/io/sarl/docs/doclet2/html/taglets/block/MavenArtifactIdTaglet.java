...
/** Taglet for {@code @mavenartifactid} tag.
 *
 ...
 * @since 0.13
 */
public class MavenArtifactIdTaglet extends AbstractSarlTaglet {
	...
	/** Constructor.
	 */
	public MavenArtifactIdTaglet() {
		super(TAGLET_NAME.toLowerCase(), false, Location.values());
	}

	/** Replies the CSS style for the MavenArtifactId text.
	 *
	...
	public String getTagBlockLabel() {
		return Messages.MavenArtifactIdTaglet_0;
	}
