 ...
 * @since 0.13
 */
public class SinceTaglet extends AbstractSarlTaglet {
	...
	/** Replies the CSS style for the since text.
	 *
	...
	public boolean isActiveTaglet(DocletOptions docletOptions) {
		return getDocletOptions().isSinceTagsEnabled();
	}
