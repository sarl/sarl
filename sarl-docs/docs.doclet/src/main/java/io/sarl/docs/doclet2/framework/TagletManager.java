...
public interface TagletManager {
	 ...
	 * @param override indicates if the provided taglet must override any previously added taglet with the same name.
	 */
	void addTaglet(Taglet taglet, boolean override);
