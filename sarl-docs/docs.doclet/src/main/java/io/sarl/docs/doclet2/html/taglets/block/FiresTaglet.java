 ...
 * @since 0.13
 */
public class FiresTaglet extends AbstractSarlTaglet {

	/** Name of the tag.
	 */
	public static final String TAGLET_NAME = "fires"; //$NON-NLS-1$
	 ...
	 */
	public FiresTaglet(String name) {
	...
	public boolean appendNode(org.jsoup.nodes.Element parent, List<? extends DocTree> tags, Element element, DocTree sourceDocumentation, CssStyles style, HtmlFactoryContentExtractor context) {
		return appendCommentTextWithComa(parent, tags, element, getTextCssStyle(style), context.getContext());
	}
