...
/** Generate the raw list of modules.
 *
 ...
 * @since 0.13
 */
public class RawModuleListGeneratorImpl extends AbstractDocumentationGenerator implements RawModuleListGenerator {

	/** Constructor.
	 */
	public RawModuleListGeneratorImpl() {
		//
	}
