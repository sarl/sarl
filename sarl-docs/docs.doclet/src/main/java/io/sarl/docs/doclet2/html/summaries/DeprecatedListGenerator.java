...
/** Generator of the list of deprecated features.
 *
 ...
 * @since 0.13
 */
public interface DeprecatedListGenerator {

	/** Generate the list of deprecated features.
	 *
	 ...
	 */
	void generate(Collection<Path> cssStylesheets, Collection<Path> jsScripts, SarlDocletEnvironment environment, DocletOptions cliOptions, Reporter reporter) throws Exception;
