 ...
 * @since 0.13
 */
public class VersionTaglet extends AbstractSarlTaglet {

	/** Name of the tag.
	 */
	public static final String TAGLET_NAME = "version"; //$NON-NLS-1$

	/** Constructor.
	 */
	public VersionTaglet() {
		super(TAGLET_NAME.toLowerCase(), false, Location.values());
	}

	/** Replies the CSS style for the version text.
	 *
	...
	protected CssStyles getTextCssStyle(CssStyles original) {
		return CssStyles.TAG_VERSION_COMMENT;
	}
	...
	public boolean isActiveTaglet(DocletOptions docletOptions) {
		return docletOptions.isVersionTagsEnabled();
	}
