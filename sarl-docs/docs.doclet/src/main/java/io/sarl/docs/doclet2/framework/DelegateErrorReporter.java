...
public class DelegateErrorReporter implements Reporter {
	...
	/** Constructor.
	 *
	 * @param delegate the delegate reporter.
	 */
	public DelegateErrorReporter(Reporter delegate) {
	...
	public void print(Kind kind, String message) {
		if (kind == Kind.ERROR || kind == Kind.MANDATORY_WARNING) {
			this.delegate.print(kind, message);
		}
	}
	...
	public void print(Kind kind, DocTreePath path, String message) {
		if (kind == Kind.ERROR || kind == Kind.MANDATORY_WARNING) {
			this.delegate.print(kind, path, message);
		}
	}
	...
	public void print(Kind kind, Element element, String message) {
		if (kind == Kind.ERROR || kind == Kind.MANDATORY_WARNING) {
			this.delegate.print(kind, element, message);
		}
	}
