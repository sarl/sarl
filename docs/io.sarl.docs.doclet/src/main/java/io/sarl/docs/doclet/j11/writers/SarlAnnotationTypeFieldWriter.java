...
/** Writer of annotation type's fields dedicated to the SARL doclet.
 *
 ...
 * @since 0.11
 */
public class SarlAnnotationTypeFieldWriter extends AnnotationTypeFieldWriterImpl {
	 ...
	 */
	public SarlAnnotationTypeFieldWriter(SubWriterHolderWriter writer, TypeElement typeElement, SARLGrammarKeywordAccess access) {
