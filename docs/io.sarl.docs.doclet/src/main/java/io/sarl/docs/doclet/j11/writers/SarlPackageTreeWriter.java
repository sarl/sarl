...
import static io.sarl.docs.doclet.j11.utils.GeneralUtils.getSkillSelector;
import static io.sarl.docs.doclet.j11.utils.GeneralUtils.getText;
...
/** Writer of the class hierarchy page for a package.
 *
 ...
 * @since 0.11
 */
public class SarlPackageTreeWriter extends PackageTreeWriter implements io.sarl.docs.doclet.j11.factories.PackageTreeWriter {
	 ...
	 */
	public SarlPackageTreeWriter(HtmlConfiguration configuration, DocPath path, PackageElement packageElement) {
		super(configuration, path, packageElement);
	}
