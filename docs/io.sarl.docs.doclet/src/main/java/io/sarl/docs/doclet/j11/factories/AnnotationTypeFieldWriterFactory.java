...
/** Factory of annotation type's field writer.
 *
 ...
 * @since 0.11
 */
public interface AnnotationTypeFieldWriterFactory {
	 ...
	 */
	AnnotationTypeFieldWriter create(SubWriterHolderWriter writer, TypeElement typeElement);
