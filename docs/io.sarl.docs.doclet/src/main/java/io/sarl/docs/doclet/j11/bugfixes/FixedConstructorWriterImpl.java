...
/** Provide bug fixes for the constructor writer.
 * 
 ...
 * @since 0.11
 */
public abstract class FixedConstructorWriterImpl extends ConstructorWriterImpl {
	 ...
	 */
	public FixedConstructorWriterImpl(SubWriterHolderWriter writer, TypeElement typeElement) {
