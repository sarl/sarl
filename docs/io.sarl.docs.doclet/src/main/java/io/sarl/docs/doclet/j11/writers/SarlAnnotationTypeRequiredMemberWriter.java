 ...
 * @since 0.11
 */
public class SarlAnnotationTypeRequiredMemberWriter extends AnnotationTypeRequiredMemberWriterImpl {
	 ...
	 */
	public SarlAnnotationTypeRequiredMemberWriter(SubWriterHolderWriter writer, TypeElement typeElement, SARLGrammarKeywordAccess access) {
