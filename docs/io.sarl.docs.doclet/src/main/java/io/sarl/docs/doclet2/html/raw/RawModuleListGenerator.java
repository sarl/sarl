...
/** Generator of the raw list of modules.
 *
 ...
 * @since 0.13
 */
public interface RawModuleListGenerator {
	 ...
	 */
	void generate(SarlDocletEnvironment environment, DocletOptions cliOptions, Reporter reporter) throws Exception;
