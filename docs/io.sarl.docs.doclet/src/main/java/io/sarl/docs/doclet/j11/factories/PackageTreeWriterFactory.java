...
/** Factory for writer of package's class hierarchy.
 *
 ...
 * @since 0.11
 */
public interface PackageTreeWriterFactory {
     ...
     *     deprecated class or interfaces.
	 * @return the instance.
	 */
	PackageTreeWriter create(HtmlConfiguration configuration, PackageElement pkg, boolean noDeprecated);
