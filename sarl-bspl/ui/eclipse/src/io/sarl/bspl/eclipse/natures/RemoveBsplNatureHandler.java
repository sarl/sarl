...
/**
 * Action for removing the BSPL nature to a project.
 *
 ...
 * @since 0.15
 */
public class RemoveBsplNatureHandler extends AbstractHandler {
	...
	protected void doConvert(IProject project, IProgressMonitor monitor) throws ExecutionException {
		monitor.setTaskName(MessageFormat.format(Messages.RemoveBsplNatureHandler_2, project.getName()));
