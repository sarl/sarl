...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bspl Protocol</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link io.sarl.bspl.lang.sarl_bspl.impl.BsplProtocolImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link io.sarl.bspl.lang.sarl_bspl.impl.BsplProtocolImpl#getModifiers <em>Modifiers</em>}</li>
 *   <li>{@link io.sarl.bspl.lang.sarl_bspl.impl.BsplProtocolImpl#getName <em>Name</em>}</li>
 *   <li>{@link io.sarl.bspl.lang.sarl_bspl.impl.BsplProtocolImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BsplProtocolImpl extends MinimalEObjectImpl.Container implements BsplProtocol
{
	...
	{
		return Sarl_bsplPackage.Literals.BSPL_PROTOCOL;
	}
	...
	public EList<XAnnotation> getAnnotations()
	{
		if (annotations == null)
		{
			annotations = new EObjectContainmentEList<XAnnotation>(XAnnotation.class, this, Sarl_bsplPackage.BSPL_PROTOCOL__ANNOTATIONS);
		}
		return annotations;
	}
	...
	public EList<String> getModifiers()
	{
		if (modifiers == null)
		{
			modifiers = new EDataTypeEList<String>(String.class, this, Sarl_bsplPackage.BSPL_PROTOCOL__MODIFIERS);
		}
		return modifiers;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Sarl_bsplPackage.BSPL_PROTOCOL__NAME, oldName, name));
	}
	...
	public EList<BsplProtocolMember> getMembers()
	{
		if (members == null)
		{
			members = new EObjectContainmentEList<BsplProtocolMember>(BsplProtocolMember.class, this, Sarl_bsplPackage.BSPL_PROTOCOL__MEMBERS);
		}
		return members;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case Sarl_bsplPackage.BSPL_PROTOCOL__ANNOTATIONS:
				return ((InternalEList<?>)getAnnotations()).basicRemove(otherEnd, msgs);
			case Sarl_bsplPackage.BSPL_PROTOCOL__MEMBERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			...
			case Sarl_bsplPackage.BSPL_PROTOCOL__MODIFIERS:
				return getModifiers();
			case Sarl_bsplPackage.BSPL_PROTOCOL__NAME:
				return getName();
			case Sarl_bsplPackage.BSPL_PROTOCOL__MEMBERS:
				return getMembers();
		}
