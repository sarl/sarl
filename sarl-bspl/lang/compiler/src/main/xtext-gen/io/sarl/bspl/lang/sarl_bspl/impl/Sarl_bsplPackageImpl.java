...
import io.sarl.bspl.lang.sarl_bspl.Sarl_bsplFactory;
 ...
 * @generated
 */
public class Sarl_bsplPackageImpl extends EPackageImpl implements Sarl_bsplPackage
{
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see io.sarl.bspl.lang.sarl_bspl.Sarl_bsplPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Sarl_bsplPackageImpl()
	{
	 ...
	 *
	 * <p>This method is used to initialize {@link Sarl_bsplPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Sarl_bsplPackage init()
	{
		if (isInited) return (Sarl_bsplPackage)EPackage.Registry.INSTANCE.getEPackage(Sarl_bsplPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredSarl_bsplPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		Sarl_bsplPackageImpl theSarl_bsplPackage = registeredSarl_bsplPackage instanceof Sarl_bsplPackageImpl ? (Sarl_bsplPackageImpl)registeredSarl_bsplPackage : new Sarl_bsplPackageImpl();
		...
		theSarl_bsplPackage.createPackageContents();

		// Initialize created meta-data
		theSarl_bsplPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSarl_bsplPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Sarl_bsplPackage.eNS_URI, theSarl_bsplPackage);
		return theSarl_bsplPackage;
	}
	 ...
	 */
	@Override
	public Sarl_bsplFactory getSarl_bsplFactory()
	{
		return (Sarl_bsplFactory)getEFactoryInstance();
	}
