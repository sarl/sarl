	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getTopElementAccess().getAlternatives(), "rule__TopElement__Alternatives");
					put(grammarAccess.getEventFeatureAccess().getAlternatives(), "rule__EventFeature__Alternatives");
					...
					put(grammarAccess.getCapacityAccess().getGroup_3(), "rule__Capacity__Group_3__0");
					put(grammarAccess.getCapacityAccess().getGroup_3_2(), "rule__Capacity__Group_3_2__0");
					...
					put(grammarAccess.getSkillAccess().getGroup_3_0(), "rule__Skill__Group_3_0__0");
					put(grammarAccess.getSkillAccess().getGroup_3_1(), "rule__Skill__Group_3_1__0");
					put(grammarAccess.getSkillAccess().getGroup_3_1_1(), "rule__Skill__Group_3_1_1__0");
					put(grammarAccess.getSkillAccess().getGroup_3_1_1_1(), "rule__Skill__Group_3_1_1_1__0");
					put(grammarAccess.getAttributeAccess().getGroup(), "rule__Attribute__Group__0");
					put(grammarAccess.getAttributeAccess().getGroup_2_0(), "rule__Attribute__Group_2_0__0");
					put(grammarAccess.getAttributeAccess().getGroup_2_0_0(), "rule__Attribute__Group_2_0_0__0");
					...
					put(grammarAccess.getBehaviorUnitAccess().getGroup_3(), "rule__BehaviorUnit__Group_3__0");
					put(grammarAccess.getActionSignatureAccess().getGroup(), "rule__ActionSignature__Group__0");
					put(grammarAccess.getActionSignatureAccess().getGroup_3(), "rule__ActionSignature__Group_3__0");
					put(grammarAccess.getActionSignatureAccess().getGroup_3_1(), "rule__ActionSignature__Group_3_1__0");
					put(grammarAccess.getActionSignatureAccess().getGroup_3_1_1(), "rule__ActionSignature__Group_3_1_1__0");
					put(grammarAccess.getActionSignatureAccess().getGroup_4(), "rule__ActionSignature__Group_4__0");
					put(grammarAccess.getActionSignatureAccess().getGroup_5(), "rule__ActionSignature__Group_5__0");
					put(grammarAccess.getActionSignatureAccess().getGroup_5_2(), "rule__ActionSignature__Group_5_2__0");
					...
					put(grammarAccess.getConstructorAccess().getGroup_2_1_1(), "rule__Constructor__Group_2_1_1__0");
					...
					put(grammarAccess.getXXLoopFormalParameterAccess().getGroup(), "rule__XXLoopFormalParameter__Group__0");
					put(grammarAccess.getXXLoopFormalParameterAccess().getGroup_2(), "rule__XXLoopFormalParameter__Group_2__0");
					...
					put(grammarAccess.getEventAccess().getSuperTypesAssignment_3_1(), "rule__Event__SuperTypesAssignment_3_1");
					put(grammarAccess.getEventAccess().getFeaturesAssignment_4_1(), "rule__Event__FeaturesAssignment_4_1");
					...
					put(grammarAccess.getBehaviorAccess().getSuperTypesAssignment_3_1(), "rule__Behavior__SuperTypesAssignment_3_1");
					put(grammarAccess.getBehaviorAccess().getFeaturesAssignment_5(), "rule__Behavior__FeaturesAssignment_5");
					put(grammarAccess.getSkillAccess().getNameAssignment_2(), "rule__Skill__NameAssignment_2");
					put(grammarAccess.getSkillAccess().getSuperTypesAssignment_3_0_1(), "rule__Skill__SuperTypesAssignment_3_0_1");
					put(grammarAccess.getSkillAccess().getImplementedTypesAssignment_3_1_1_0(), "rule__Skill__ImplementedTypesAssignment_3_1_1_0");
					put(grammarAccess.getSkillAccess().getImplementedTypesAssignment_3_1_1_1_1(), "rule__Skill__ImplementedTypesAssignment_3_1_1_1_1");
					put(grammarAccess.getSkillAccess().getFeaturesAssignment_5(), "rule__Skill__FeaturesAssignment_5");
					put(grammarAccess.getAttributeAccess().getWriteableAssignment_1_0(), "rule__Attribute__WriteableAssignment_1_0");
					put(grammarAccess.getAttributeAccess().getNameAssignment_2_0_0_0(), "rule__Attribute__NameAssignment_2_0_0_0");
					put(grammarAccess.getAttributeAccess().getTypeAssignment_2_0_0_2(), "rule__Attribute__TypeAssignment_2_0_0_2");
					...
					put(grammarAccess.getCapacityUsesAccess().getCapacitiesUsedAssignment_2(), "rule__CapacityUses__CapacitiesUsedAssignment_2");
					put(grammarAccess.getCapacityUsesAccess().getCapacitiesUsedAssignment_3_1(), "rule__CapacityUses__CapacitiesUsedAssignment_3_1");
					put(grammarAccess.getRequiredCapacityAccess().getRequiredCapacitiesAssignment_2(), "rule__RequiredCapacity__RequiredCapacitiesAssignment_2");
					put(grammarAccess.getRequiredCapacityAccess().getRequiredCapacitiesAssignment_3_1(), "rule__RequiredCapacity__RequiredCapacitiesAssignment_3_1");
					put(grammarAccess.getBehaviorUnitAccess().getNameAssignment_2(), "rule__BehaviorUnit__NameAssignment_2");
					put(grammarAccess.getBehaviorUnitAccess().getGuardAssignment_3_1(), "rule__BehaviorUnit__GuardAssignment_3_1");
					put(grammarAccess.getBehaviorUnitAccess().getBodyAssignment_4(), "rule__BehaviorUnit__BodyAssignment_4");
					put(grammarAccess.getActionSignatureAccess().getNameAssignment_2(), "rule__ActionSignature__NameAssignment_2");
					put(grammarAccess.getActionSignatureAccess().getParamsAssignment_3_1_0(), "rule__ActionSignature__ParamsAssignment_3_1_0");
					put(grammarAccess.getActionSignatureAccess().getParamsAssignment_3_1_1_1(), "rule__ActionSignature__ParamsAssignment_3_1_1_1");
					put(grammarAccess.getActionSignatureAccess().getVarargsAssignment_3_1_2(), "rule__ActionSignature__VarargsAssignment_3_1_2");
					put(grammarAccess.getActionSignatureAccess().getTypeAssignment_4_1(), "rule__ActionSignature__TypeAssignment_4_1");
					put(grammarAccess.getActionSignatureAccess().getFiredEventsAssignment_5_1(), "rule__ActionSignature__FiredEventsAssignment_5_1");
					put(grammarAccess.getActionSignatureAccess().getFiredEventsAssignment_5_2_1(), "rule__ActionSignature__FiredEventsAssignment_5_2_1");
					put(grammarAccess.getActionAccess().getNameAssignment_2(), "rule__Action__NameAssignment_2");
					put(grammarAccess.getActionAccess().getParamsAssignment_3_1_0(), "rule__Action__ParamsAssignment_3_1_0");
					put(grammarAccess.getActionAccess().getParamsAssignment_3_1_1_1(), "rule__Action__ParamsAssignment_3_1_1_1");
					put(grammarAccess.getActionAccess().getVarargsAssignment_3_1_2(), "rule__Action__VarargsAssignment_3_1_2");
					put(grammarAccess.getActionAccess().getTypeAssignment_4_1(), "rule__Action__TypeAssignment_4_1");
					put(grammarAccess.getActionAccess().getFiredEventsAssignment_5_1(), "rule__Action__FiredEventsAssignment_5_1");
					put(grammarAccess.getActionAccess().getFiredEventsAssignment_5_2_1(), "rule__Action__FiredEventsAssignment_5_2_1");
					put(grammarAccess.getActionAccess().getBodyAssignment_6(), "rule__Action__BodyAssignment_6");
					put(grammarAccess.getConstructorAccess().getParamsAssignment_2_1_0(), "rule__Constructor__ParamsAssignment_2_1_0");
					put(grammarAccess.getConstructorAccess().getParamsAssignment_2_1_1_1(), "rule__Constructor__ParamsAssignment_2_1_1_1");
					put(grammarAccess.getConstructorAccess().getVarargsAssignment_2_1_2(), "rule__Constructor__VarargsAssignment_2_1_2");
					put(grammarAccess.getConstructorAccess().getBodyAssignment_3(), "rule__Constructor__BodyAssignment_3");
					put(grammarAccess.getFormalParameterAccess().getNameAssignment_0(), "rule__FormalParameter__NameAssignment_0");
					put(grammarAccess.getFormalParameterAccess().getParameterTypeAssignment_2(), "rule__FormalParameter__ParameterTypeAssignment_2");
					...
					put(grammarAccess.getXXLoopFormalParameterAccess().getNameAssignment_1(), "rule__XXLoopFormalParameter__NameAssignment_1");
					put(grammarAccess.getXXLoopFormalParameterAccess().getParameterTypeAssignment_2_1(), "rule__XXLoopFormalParameter__ParameterTypeAssignment_2_1");
					...
					put(grammarAccess.getSkillAccess().getUnorderedGroup_3(), "rule__Skill__UnorderedGroup_3");
				}
			};
		}
