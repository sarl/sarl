		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFieldAccess().getAlternatives_3_1_2(), "rule__Field__Alternatives_3_1_2");
					...
					put(grammarAccess.getXVariableDeclarationAccess().getAlternatives_0_0_2(), "rule__XVariableDeclaration__Alternatives_0_0_2");
					...
					put(grammarAccess.getFieldAccess().getGroup_3_0_3(), "rule__Field__Group_3_0_3__0");
					put(grammarAccess.getFieldAccess().getGroup_3_0_3_0(), "rule__Field__Group_3_0_3_0__0");
					put(grammarAccess.getFieldAccess().getGroup_3_1(), "rule__Field__Group_3_1__0");
					put(grammarAccess.getFieldAccess().getGroup_3_1_2_0(), "rule__Field__Group_3_1_2_0__0");
					put(grammarAccess.getFieldAccess().getGroup_3_1_2_0_0(), "rule__Field__Group_3_1_2_0_0__0");
					...
					put(grammarAccess.getActionAccess().getGroup_9_2_2(), "rule__Action__Group_9_2_2__0");
					...
					put(grammarAccess.getConstructorAccess().getGroup_6_0(), "rule__Constructor__Group_6_0__0");
					put(grammarAccess.getConstructorAccess().getGroup_6_0_2(), "rule__Constructor__Group_6_0_2__0");
					put(grammarAccess.getConstructorAccess().getGroup_6_1(), "rule__Constructor__Group_6_1__0");
					put(grammarAccess.getConstructorAccess().getGroup_6_1_2(), "rule__Constructor__Group_6_1_2__0");
					...
					put(grammarAccess.getFieldAccess().getModifiersAssignment_3_0_0(), "rule__Field__ModifiersAssignment_3_0_0");
					put(grammarAccess.getFieldAccess().getModifiersAssignment_3_0_1(), "rule__Field__ModifiersAssignment_3_0_1");
					put(grammarAccess.getFieldAccess().getModifiersAssignment_3_0_2(), "rule__Field__ModifiersAssignment_3_0_2");
					put(grammarAccess.getFieldAccess().getNameAssignment_3_0_3_0_0(), "rule__Field__NameAssignment_3_0_3_0_0");
					put(grammarAccess.getFieldAccess().getTypeAssignment_3_0_3_0_2(), "rule__Field__TypeAssignment_3_0_3_0_2");
					put(grammarAccess.getFieldAccess().getModifiersAssignment_3_1_0(), "rule__Field__ModifiersAssignment_3_1_0");
					put(grammarAccess.getFieldAccess().getModifiersAssignment_3_1_1(), "rule__Field__ModifiersAssignment_3_1_1");
					put(grammarAccess.getFieldAccess().getNameAssignment_3_1_2_0_0_0(), "rule__Field__NameAssignment_3_1_2_0_0_0");
					put(grammarAccess.getFieldAccess().getTypeAssignment_3_1_2_0_0_2(), "rule__Field__TypeAssignment_3_1_2_0_0_2");
					put(grammarAccess.getFieldAccess().getNameAssignment_3_1_2_1(), "rule__Field__NameAssignment_3_1_2_1");
					put(grammarAccess.getFieldAccess().getInitialValueAssignment_4_1(), "rule__Field__InitialValueAssignment_4_1");
					...
					put(grammarAccess.getActionAccess().getTypeParametersAssignment_9_2_1(), "rule__Action__TypeParametersAssignment_9_2_1");
					put(grammarAccess.getActionAccess().getTypeParametersAssignment_9_2_2_1(), "rule__Action__TypeParametersAssignment_9_2_2_1");
					...
					put(grammarAccess.getConstructorAccess().getExceptionsAssignment_6_0_1(), "rule__Constructor__ExceptionsAssignment_6_0_1");
					put(grammarAccess.getConstructorAccess().getExceptionsAssignment_6_0_2_1(), "rule__Constructor__ExceptionsAssignment_6_0_2_1");
					put(grammarAccess.getConstructorAccess().getTypeParametersAssignment_6_1_1(), "rule__Constructor__TypeParametersAssignment_6_1_1");
					put(grammarAccess.getConstructorAccess().getTypeParametersAssignment_6_1_2_1(), "rule__Constructor__TypeParametersAssignment_6_1_2_1");
					...
					put(grammarAccess.getXVariableDeclarationAccess().getExtensionAssignment_0_0_1(), "rule__XVariableDeclaration__ExtensionAssignment_0_0_1");
					put(grammarAccess.getXVariableDeclarationAccess().getWriteableAssignment_0_0_2_0(), "rule__XVariableDeclaration__WriteableAssignment_0_0_2_0");
					...
					put(grammarAccess.getConstructorAccess().getUnorderedGroup_6(), "rule__Constructor__UnorderedGroup_6");
