		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getParameterAccess().getGroup_6_0(), "rule__Parameter__Group_6_0__0");
					...
					put(grammarAccess.getSarlScriptAccess().getNameAssignment_1_1(), "rule__SarlScript__NameAssignment_1_1");
					put(grammarAccess.getSarlScriptAccess().getImportSectionAssignment_2(), "rule__SarlScript__ImportSectionAssignment_2");
					put(grammarAccess.getSarlScriptAccess().getElementsAssignment_3(), "rule__SarlScript__ElementsAssignment_3");
					...
					put(grammarAccess.getSarlBehaviorUnitAccess().getExpressionAssignment_6_0(), "rule__SarlBehaviorUnit__ExpressionAssignment_6_0");
					put(grammarAccess.getSarlBehaviorUnitAccess().getExpressionAssignment_6_1(), "rule__SarlBehaviorUnit__ExpressionAssignment_6_1");
					put(grammarAccess.getSarlCapacityUsesAccess().getCapacitiesAssignment_2(), "rule__SarlCapacityUses__CapacitiesAssignment_2");
					put(grammarAccess.getSarlCapacityUsesAccess().getCapacitiesAssignment_3_1(), "rule__SarlCapacityUses__CapacitiesAssignment_3_1");
					put(grammarAccess.getSarlRequiredCapacityAccess().getCapacitiesAssignment_2(), "rule__SarlRequiredCapacity__CapacitiesAssignment_2");
					put(grammarAccess.getSarlRequiredCapacityAccess().getCapacitiesAssignment_3_1(), "rule__SarlRequiredCapacity__CapacitiesAssignment_3_1");
					...
					put(grammarAccess.getSarlEventAccess().getExtendsAssignment_6_1(), "rule__SarlEvent__ExtendsAssignment_6_1");
					put(grammarAccess.getSarlEventAccess().getMembersAssignment_7_1(), "rule__SarlEvent__MembersAssignment_7_1");
					...
					put(grammarAccess.getSarlAgentAccess().getExtendsAssignment_6_1(), "rule__SarlAgent__ExtendsAssignment_6_1");
					put(grammarAccess.getSarlAgentAccess().getMembersAssignment_8(), "rule__SarlAgent__MembersAssignment_8");
					...
					put(grammarAccess.getSarlCapacityAccess().getExtendsAssignment_6_1(), "rule__SarlCapacity__ExtendsAssignment_6_1");
					put(grammarAccess.getSarlCapacityAccess().getExtendsAssignment_6_2_1(), "rule__SarlCapacity__ExtendsAssignment_6_2_1");
					put(grammarAccess.getSarlCapacityAccess().getMembersAssignment_8(), "rule__SarlCapacity__MembersAssignment_8");
					...
					put(grammarAccess.getSarlBehaviorAccess().getExtendsAssignment_6_1(), "rule__SarlBehavior__ExtendsAssignment_6_1");
					put(grammarAccess.getSarlBehaviorAccess().getMembersAssignment_8(), "rule__SarlBehavior__MembersAssignment_8");
					...
					put(grammarAccess.getSarlSkillAccess().getExtendsAssignment_6_0_1(), "rule__SarlSkill__ExtendsAssignment_6_0_1");
					put(grammarAccess.getSarlSkillAccess().getImplementsAssignment_6_1_1_0(), "rule__SarlSkill__ImplementsAssignment_6_1_1_0");
					put(grammarAccess.getSarlSkillAccess().getImplementsAssignment_6_1_1_1_1(), "rule__SarlSkill__ImplementsAssignment_6_1_1_1_1");
					put(grammarAccess.getSarlSkillAccess().getMembersAssignment_8(), "rule__SarlSkill__MembersAssignment_8");
					...
					put(grammarAccess.getParameterAccess().getDefaultValueAssignment_6_0_1(), "rule__Parameter__DefaultValueAssignment_6_0_1");
					put(grammarAccess.getParameterAccess().getVarArgAssignment_6_1(), "rule__Parameter__VarArgAssignment_6_1");
