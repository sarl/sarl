...
/**
 * Quick fixes for {@link IssueCodes#INVALID_CAPACITY_TYPE}.
 *
 ...
 */
public final class InvalidCapacityTypeModification extends SARLSemanticModification {
	...
	public static void accept(SARLQuickfixProvider provider, Issue issue, IssueResolutionAcceptor acceptor) {
		...
		if (data != null && data.length >= 1) {
			...
			InvalidCapacityTypeModification modification = new InvalidCapacityTypeModification();
