...
/**
 * Quick fixes for {@link IssueCodes#INVALID_IMPLEMENTED_TYPE}.
 *
 ...
 */
public final class InvalidImplementedTypeModification extends SARLSemanticModification {
	...
	public static void accept(SARLQuickfixProvider provider, Issue issue, IssueResolutionAcceptor acceptor) {
		...
		if (data != null && data.length >= 1) {
			...
			InvalidImplementedTypeModification modification = new InvalidImplementedTypeModification();
