...
/**
 * Quick fixes for {@link IssueCodes#REDUNDANT_CAPACITY_USE}.
 *
 ...
 */
public final class RedundantCapacityUseModification extends SARLSemanticModification {
	...
	public static void accept(SARLQuickfixProvider provider, Issue issue, IssueResolutionAcceptor acceptor) {
		...
		if (data != null && data.length >= 1) {
			...
			RedundantCapacityUseModification modification = new RedundantCapacityUseModification();
