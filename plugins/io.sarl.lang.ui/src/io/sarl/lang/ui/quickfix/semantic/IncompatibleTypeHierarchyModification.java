...
/**
 * Quick fixes for {@link IssueCodes#INCONSISTENT_TYPE_HIERARCHY}.
 *
 ...
 */
public final class IncompatibleTypeHierarchyModification extends SARLSemanticModification {
	...
	public static void accept(SARLQuickfixProvider provider, Issue issue, IssueResolutionAcceptor acceptor) {
		...
		if (data != null && data.length >= 2) {
			...
			IncompatibleTypeHierarchyModification modification = new IncompatibleTypeHierarchyModification();
