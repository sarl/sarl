...
public class Messages extends NLS {
	private static final String BUNDLE_NAME = "io.sarl.eclipse.wizards.elements.newbehavior.messages"; //$NON-NLS-1$
	static {
	...
	public static String NewSarlBehaviorWizardPage_2;
}
