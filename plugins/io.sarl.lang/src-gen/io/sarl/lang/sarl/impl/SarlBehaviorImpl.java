 ...
 * <ul>
 *   <li>{@link io.sarl.lang.sarl.impl.SarlBehaviorImpl#getSuperTypes <em>Super Types</em>}</li>
 *   <li>{@link io.sarl.lang.sarl.impl.SarlBehaviorImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SarlBehaviorImpl extends XtendTypeDeclarationImpl implements SarlBehavior
{
  ...
  public EList<JvmParameterizedTypeReference> getSuperTypes()
  {
    if (superTypes == null)
    {
      superTypes = new EObjectContainmentEList<JvmParameterizedTypeReference>(JvmParameterizedTypeReference.class, this, SarlPackage.SARL_BEHAVIOR__SUPER_TYPES);
    }
    return superTypes;
  }
  ...
  public EList<XtendMember> getFeatures()
  {
    if (features == null)
    {
      features = new EObjectContainmentEList<XtendMember>(XtendMember.class, this, SarlPackage.SARL_BEHAVIOR__FEATURES);
    }
    return features;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SarlPackage.SARL_BEHAVIOR__SUPER_TYPES:
        return ((InternalEList<?>)getSuperTypes()).basicRemove(otherEnd, msgs);
      case SarlPackage.SARL_BEHAVIOR__FEATURES:
