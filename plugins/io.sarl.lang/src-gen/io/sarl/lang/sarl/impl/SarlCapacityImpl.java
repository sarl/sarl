 ...
 * </p>
 * <ul>
 *   <li>{@link io.sarl.lang.sarl.impl.SarlCapacityImpl#getExtends <em>Extends</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SarlCapacityImpl extends XtendTypeDeclarationImplCustom implements SarlCapacity
{
	/**
	...
	public EList<JvmParameterizedTypeReference> getExtends()
	{
		if (extends_ == null)
		{
			extends_ = new EObjectContainmentEList<JvmParameterizedTypeReference>(JvmParameterizedTypeReference.class, this, SarlPackage.SARL_CAPACITY__EXTENDS);
		}
		return extends_;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
	{
		switch (featureID)
		{
			case SarlPackage.SARL_CAPACITY__EXTENDS:
