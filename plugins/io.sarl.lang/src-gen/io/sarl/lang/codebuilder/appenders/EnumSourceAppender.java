...
public class EnumSourceAppender extends AbstractSourceAppender implements IEnumBuilder {

	private final IEnumBuilder builder;

	public EnumSourceAppender(IEnumBuilder builder) {
	...
	public IXtendEnumLiteralBuilder addXtendEnumLiteral(String name) {
		return this.builder.addXtendEnumLiteral(name);
	}
