...
public class CapacitySourceAppender extends AbstractSourceAppender implements ICapacityBuilder {

	private final ICapacityBuilder builder;

	public CapacitySourceAppender(ICapacityBuilder builder) {
