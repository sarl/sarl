...
/** Source adapter of a Sarl SarlSkill.
 */
@SuppressWarnings("all")
public class SkillSourceAppender extends AbstractSourceAppender implements ISkillBuilder {

	private final ISkillBuilder builder;

	public SkillSourceAppender(ISkillBuilder builder) {
		this.builder = builder;
	}

	public void build(ISourceAppender appender) throws IOException {
		build(this.builder.getSarlSkill(), appender);
	}
