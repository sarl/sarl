...
/** Source appender of a Sarl Field.
 */
@SuppressWarnings("all")
public class FieldSourceAppender extends AbstractSourceAppender implements IFieldBuilder {

	private final IFieldBuilder builder;

	public FieldSourceAppender(IFieldBuilder builder) {
