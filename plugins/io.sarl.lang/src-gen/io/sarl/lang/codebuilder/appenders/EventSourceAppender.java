...
public class EventSourceAppender extends AbstractSourceAppender implements IEventBuilder {

	private final IEventBuilder builder;

	public EventSourceAppender(IEventBuilder builder) {
