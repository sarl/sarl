...
/** Source appender of a Sarl AnnotationField.
 */
@SuppressWarnings("all")
public class AnnotationFieldSourceAppender extends AbstractSourceAppender implements IAnnotationFieldBuilder {

	private final IAnnotationFieldBuilder builder;

	public AnnotationFieldSourceAppender(IAnnotationFieldBuilder builder) {
	 ...
	 * @param container - the container of the AnnotationField.
