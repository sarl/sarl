...
//		super.checkClassPath(sarlScript);
//
...
//	}
//
//	/** Check if the default value is compatible with the corresponding parameter type.
//	 *
//	 * @param parameter - the parameter.
//	 */
//	@Check(CheckType.FAST)
//	public void checkDefaultValueTypeCompatibleWithParameterType(SarlFormalParameter parameter) {
//		if (parameter.getDefaultValue() != null) {
//			JvmTypeReference rawType = parameter.getParameterType();
//			if (rawType != null) {
//				LightweightTypeReference toType = toLightweightTypeReference(rawType, true);
//				LightweightTypeReference fromType = getActualType(parameter.getDefaultValue());
...
//		super.checkMemberNamesAreUnique(xtendType);
//	}
//
...
//	}
//
//	/** Check if the given function must be abstract.
//	 *
//	 * @param function - the action to check.
//	 */
//	@Check
//	@Override
...
//			&& function.getDeclaringType() instanceof SarlCapacity) {
//			error(MessageFormat.format(
//					"The abstract method {0} must not specify a body",
//					function.getName()),
...
//	 * @see ModelUtil#isHiddenAttribute(String)
//	 */
//	@Check(CheckType.FAST)
//	public void checkAttributeName(XtendField attribute) {
...
//							attribute.getName()),
//							attribute,
//							XtendPackage.Literals.XTEND_FIELD__NAME,
//							ValidationMessageAcceptor.INSIGNIFICANT_INDEX,
//							org.eclipse.xtext.xbase.validation.IssueCodes.INVALID_IDENTIFIER,
...
//							event.getQualifiedName(),
//							Messages.SARLValidator_26,
//							this.grammarAccess.getBehaviorUnitAccess().getOnKeyword_3().getValue()),
//							event,
//							null,
//							ValidationMessageAcceptor.INSIGNIFICANT_INDEX,
...
//	 */
//	@Check(CheckType.FAST)
//	public void checkCapacityFeatures(Capacity capacity) {
