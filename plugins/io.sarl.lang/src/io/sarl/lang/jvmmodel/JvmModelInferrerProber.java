...
public class JvmModelInferrerProber {
	...
	public enum Step {
		...
		/** Step 0 of {@link SARLJvmModelInferrer#generateCodeForFeatures(org.eclipse.xtext.common.types.JvmGenericType,
		 * io.sarl.lang.sarl.InheritingElement, io.sarl.lang.sarl.FeatureContainer, boolean, java.util.Map)}.
		 */
		GENERATE_CODE_FOR_FEATURES_0,

		/** Step 1 of {@link SARLJvmModelInferrer#generateCodeForFeatures(org.eclipse.xtext.common.types.JvmGenericType,
		 * io.sarl.lang.sarl.InheritingElement, io.sarl.lang.sarl.FeatureContainer, boolean, java.util.Map)}.
		 */
		GENERATE_CODE_FOR_FEATURES_1,

		/** Step 2 of {@link SARLJvmModelInferrer#generateCodeForFeatures(org.eclipse.xtext.common.types.JvmGenericType,
		 * io.sarl.lang.sarl.InheritingElement, io.sarl.lang.sarl.FeatureContainer, boolean, java.util.Map)}.
		 */
		GENERATE_CODE_FOR_FEATURES_2,

		/** Step 3 of {@link SARLJvmModelInferrer#generateCodeForFeatures(org.eclipse.xtext.common.types.JvmGenericType,
		 * io.sarl.lang.sarl.InheritingElement, io.sarl.lang.sarl.FeatureContainer, boolean, java.util.Map)}.
		 */
