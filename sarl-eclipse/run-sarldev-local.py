...
sarl_ide_path = os.path.join(script_dir, 'products', 'io.sarl.eclipse.products.dev', 'target', 'products', 'io.sarl.eclipse.products.dev')

if current_system == Version.WINDOWS:
	sarl_ide_path = os.path.join(sarl_ide_path, 'win32', 'win32', 'x86_64', 'sarldev.exe')
	sarl_ide_path = os.path.realpath(sarl_ide_path)
elif current_system == Version.MACOSX86:
	sarl_ide_path = os.path.join(sarl_ide_path, 'macosx', 'cocoa', 'x86_64', 'Eclipse.app', 'Contents', 'MacOS', 'sarldev')
	sarl_ide_path = os.path.realpath(sarl_ide_path)
elif current_system == Version.MACOSA86:
	sarl_ide_path = os.path.join(sarl_ide_path, 'macosx', 'cocoa', 'aarch64', 'Eclipse.app', 'Contents', 'MacOS', 'sarldev')
	sarl_ide_path = os.path.realpath(sarl_ide_path)
else:
	sarl_ide_path = os.path.join(sarl_ide_path, 'linux', 'gtk', 'x86_64', 'sarldev-ubuntu.sh')
