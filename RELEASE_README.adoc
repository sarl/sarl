...
**COPY the products from "sarl-eclipse/products/io.sarl.eclipse.products.ide/target/products/" in a safe folder for being used in Phase 3.**
...
**COPY the bundles from "target/maven-central-bundles/" in a safe folder for being used in Phase 3.**
...
**COPY the generated website from "target/site/apidocs/" in a safe folder for being used in Phase 3.**
...
**COPY the generated changelog from "target/changes.md" in a safe folder for being used in Phase 3.**
